define(['jquery', 'backbone', 'utils/tpl', 'utils/loadFile', 'utils/Confirmer',
        'redactor/redactor/redactor', 'views/TestExtend'],
    function($, Backbone, tpl, loadFile, confirmer, redactor, TestExtend){
        var DetailViewNews = TestExtend.extend({
            tagName: 'div',
            events:{
            ...
            deleteWork: function(){
                ...
                if(!conf.question("Potwierdź usunięcie obiektu")) return;
